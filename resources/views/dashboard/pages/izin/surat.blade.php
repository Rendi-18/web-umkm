    ...
    <div class="content-wrapper ">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div id="regist-koperasi" class="">
                <form action="/dashboard/izin/surat" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- NIB/NIK --}}
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="nib" class="form-control @error('nib') is-invalid @enderror"
                                    id="nib" placeholder="Nomor Induk Koperasi" value="{{ old('nib') }}" required>
                                @error('name')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="phonenumber" id="phonenumber"
                                    ...
                                    placeholder="+62" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2"
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary"><span class='bx bx-mail-send'></span> &nbsp;
                                Send</button>
                        </div>
                    </div>
                </form>
