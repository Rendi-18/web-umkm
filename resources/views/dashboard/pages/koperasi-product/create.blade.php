                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control @error('umkm_id') is-invalid @enderror"
                                    id="umkm_id" placeholder="Id Umkm" name="umkm_id" value="Umkm ID" required>
                                {{-- @error('umkm_id')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                    id="slug" placeholder="Slug" name="slug" value="slug" required>
                                {{-- @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" placeholder="Nama" name="name" value="nama produk" required>
                                {{-- @error('name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('price') is-invalid @enderror"
                                    id="price" placeholder="Harga" name="price" value="#" required>
                                {{-- @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('weight') is-invalid @enderror"
                                    id="weight" placeholder="Berat" name="weight" value="#" required>
                                {{-- @error('weight')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control @error('description') is-invalid @enderror"
                                    id="description" placeholder="Deskripsi" name="description" value="#n') }}"
                                    required>
