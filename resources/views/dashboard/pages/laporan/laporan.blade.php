<section id="regist-koperasi">
            ...
            <div class="row">
                <div class="col-lg">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="" action="/dashboard/laporan" method="POST"
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="date" name="tahun" id="tahun"
                                                ...
                                                placeholder="Jenis Bantuan.." value={{ old('tahun') }} required>
                                            @error('tahun')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                {{-- File --}}
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="image">Laporan</label>
    ...
    <div class="col-12 mb-5">
        ...
        <div class="card">
            ...
            <form action="/dashboard/laporan/surat" method="get" class="d-flex mx-4 mb-2">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                        @if (Auth::user()->laporan->count())
                            @foreach (Auth::user()->laporan as $laporan)
                                <tr>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <form id="userDelete-form"
                                                    action="/dashboard/laporan/{{ $laporan->id }}" method="post">
                                                    @method('delete')
                                                    @csrf
                                                ...
                                                @if ($laporan->accept)
                                                    <a class="dropdown-item " target="_blank"
                                                        href="{{ asset('storage/' . $laporan->accept) }}" download><i
